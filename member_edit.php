									  ...
									  <td width="774"><table width="774"  border="0" cellspacing="0" cellpadding="0">
										    <tr>
														  ...
														  <tr>
															...
															<?php
/*
$connection = mysql_pconnect($db_ad,$db_name,$db_pass) or die(mysql_error());  
 ...
 */
  ...
  // แสดงผลถ้ามีข้อมูลในฐานข้อมูล 
   //echo "<img height= 150 width= 150 src=\"../member/images/{$row_rs_image['Im_Member']}\" />";
    //} ?>
    
<form method="POST" action="member_edit_process.php">
<?php
$user = $_SESSION["valid_user"];
$result_member_edit = mysqli_query($con, "SELECT *
FROM bso_member WHERE Us_Member =  '{$user}' " );
$row_member_edit = mysqli_fetch_array($result_member_edit);
echo "<h3 align=\"center\" >แก้ไขรายละเอียด User</h3>";
echo"<table width=\"100%\"  border=\"0\" align=\"center\" cellpadding=\"5\" cellspacing=\"1\">";

echo"  <tr style=\"background-color:#F2F2F2\">";
echo"  <td colspan=\"3\"> User: {$row_member_edit['Us_Member']} </td>";
 echo" </tr>";
  echo"<tr style=\"background-color:#F2F2F2\">";
echo"    <td colspan=\"3\">ชื่อ: <input  name=\"na_member\" type=\"text\" value= {$row_member_edit['Na_Member']}></td>";
echo"  </tr>";
echo"  <tr style=\"background-color:#F2F2F2\">";
echo"    <td colspan=\"3\">ที่อยู่: <input size=\"100\" name=\"ad_member\" type=\"text \" value= {$row_member_edit['Ad_Member']}></td>";
echo"  </tr>";
echo"  <tr style=\"background-color:#F2F2F2\">";
echo"    <td colspan=\"3\">เบอร์โทร: <input  name =\"te_member\" type=\"\" value= {$row_member_edit['Te_Member']}></td>";
 echo" </tr>";
echo"<tr style=\"background-color:#F2F2F2\">";
echo"<td colspan=\"3\">อีเมล์ : <input  name=\"em_member\" type=\"email\" value= {$row_member_edit['Em_Member']}></td>";
echo"<tr>";
 echo" </tr>";
echo"</table>"."<br>";
