...
<div id="wrapper">
	...
	<div id="rightContent">
	  ...
	  <div class="shortcutHome"></div>
     	<div class="informasi">
		รายละเอียดสมาชิก
        <?php print"<a href=\"member_edit.php?ID_Member={$_GET['ID_Member']}\"><img src=\"mos-css/img/edit.png\"></a>"; ?>
        </div>
...
$row = mysqli_fetch_array($result);
        ...
        <tr><td colspan="2" align="center"><?php //echo "<img height= 400 width=300 src=\"images/{$row['images']}\" />" ?></td>
            ...
            <tr class="data">
				...
				<td class="data"><?php echo "{$row['Ad_Member']}" ?></td>
			</tr>
            <tr class="data">
				...
				<td class="data"><?php echo "{$row['Em_Member']}" ?></td>
			</tr>
		</table>
