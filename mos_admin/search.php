...
function process_form() {
  ...
  include('../config.inc');
  $sql = "SELECT * FROM bso_order  WHERE ID_Order LIKE '%{$search_term}%';"; // เงื่อนไขการค้นหาจากฐานข้อมูล
  ...
  while ($row = mysqli_fetch_array($result)) {
    echo "<b>{$i}.";
    echo "<a href=\"order_detail.php?ID_Order={$row['ID_Order']}\">{$row['ID_Order']}</a><br>\n";
