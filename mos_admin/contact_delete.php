...
$sql = "DELETE FROM bso_contact WHERE id_contact='{$ID_Contact}'";
$result = mysqli_query($con, $sql);
  echo "<h3>ผลการลบ</h3>\n";
  if ($result) {
    echo "ลบข้อความสำเร็จ " ."<br>";
		echo "<META HTTP-EQUIV=refresh CONTENT=\"0; URL=contact_manager.php\">";
  }
  else {
    echo "เกิดข้อผิดพลาด ไม่สามารถลบได้<br>";
  }
  mysqli_close($con);
  echo '<a href="contact_manager.php">กลับ</a>';
