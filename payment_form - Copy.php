...
echo" </tr>";
echo"  <tr>";
echo"  <td colspan=\"3\">เลขที่ใบเสร็จ <input  name=\"id_order\" type=\"text\" >   </td>";
 echo" </tr>";
echo"<tr>";
echo"    <td colspan=\"3\">จำนวนเงิน: <input  name=\"number\" type=\"text\" >บาท</td>";
echo"  </tr>";
echo"  <tr >";
echo"    <td colspan=\"3\">วันที่จ่าย: <input size=\"20\" name=\"date\" type=\"text \" ></td>";
echo"  </tr>";
echo"  <tr>";
echo"    <td colspan=\"3\">หมายเหตุ: <input size=\"50\" name =\"comment\" type=\"\" ></td>";
 echo" </tr>";
