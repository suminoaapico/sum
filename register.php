...
<?php                                             
	...
	?>										
									  ...
									  <td width="774"><table width="774"  border="0" cellspacing="0" cellpadding="0">
										    <tr>
																<td width="22">&nbsp;</td>
																<td width="729"><!-- InstanceBeginEditable name="EditRegion1" --><h3 align="center">สมัครสมาชิก</h3><!-- InstanceEndEditable --></td>
																<td width="23">&nbsp;</td>
									    </tr>
														  <tr>
																<td height="479">&nbsp;</td>
															<td align="left" valign="top"><!-- InstanceBeginEditable name="EditRegion2" -->
																    ...
																    <tr>
																      <td height="40" class="popular"><img src="images/spacer.gif" alt="" width="27" height="19"><span class="popular_text">Register</span></td>
															        </tr>
																    <tr>
																      <td height="138" valign="top" class="popular_center"><table width="774" height="139"  border="0" cellpadding="0" cellspacing="0">
																        <tr>
                                                                         ...
                                                                         <tr><td>&nbsp;</td></tr>
							 <tr><td>User</td><td width="92%"><?php echo"  <input  name=\"us_member\" type=\"text\" > "; ?></td></tr>
                              <tr><td>Password</td><td><?php echo"  <input  name=\"pa_member\" type=\"password\" >"; ?></td></tr>
                              <tr>     
                                <tr><td>ชื่อ</td><td><?php echo"<input  name=\"na_member\" type=\"text\" >";?></td></tr>
                              <tr>     
                                <tr><td>ที่อยู่</td><td><?php echo"<input  name=\"ad_member\" type=\"text \" >"; ?></td></tr>
                              <tr>     
                                <tr><td>เบอร์โทร</td><td><?php echo" <input  name =\"te_member\" type=\"text\" >";?></td></tr>
                              <tr>     
                                <tr><td>อีเมล์</td><td><?php echo"<input  name=\"em_member\" type=\"email\" >";?></td></tr>
                              <tr>  
                                <tr><td><input type="submit" name="send" value="สมัครสมาชิก"></td><td></td></tr>
