...
<?php                                             
	...
	include('config.inc');
	$sel = "SELECT * FROM $bso_bo , bso_book_category  WHERE bso_book.ID_Ca=bso_book_category.ID_Ca";
$result = mysqli_query($con,$sel);
while($row = mysqli_fetch_array($result)){   
															
	echo"<table width=\"207\" height=\"234\"  border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"productleft_top\">
				<tr>
						<td align=\"left\" valign=\"top\" class=\"hottovar\">
										          				<table width=\"207\"  border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
																							  <tr>
																								<td height=\"200\" valign=\"top\">
																									<table width=\"100%\"  border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
																							 <tr>
							<td height=\"53\"><span class=\"style7\"><a href=\"book_detail.php?ID_Book={$row[$id_bo]}\">{$row[$na_bo]}</a></span></td>
																									  </tr>
																									  <tr>
																										<td height=\"147\" align=\"center\"><a href=\"#\"><img src=\"mos_admin/images/{$row[$im_bo]}\" alt=\"\" width=\"120\" height=\"144\" border=\"0\"></a></td>
																									  </tr>
																							  ...
																							  <tr>
																								<td height=\"35\">
																									<table width=\"100%\"  border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
																									  <tr>
																										<td width=\"38%\" height=\"24\"><span class=\"style7\"><a href=\"book_detail.php?ID_Book={$row[$id_bo]}\" id=\"blue1\">More details</a></span></td>
																										<td width=\"23%\">&nbsp;</td>
																										<td width=\"39%\" class=\"price\">{$row[$va_bo]} ฿</td>
																									  </tr>
																									</table>
																								</td>
																							  </tr>
