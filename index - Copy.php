...
<?php                                             
	...
	?>										
        ...
        <?php         $sel1 = "SELECT * FROM bso_book, bso_book_category  WHERE bso_book.ID_Ca=bso_book_category.ID_Ca LIMIT 0, 4 ";
$result = mysqli_query($con,$sel1);
while($row = mysqli_fetch_array($result)){                                                            
																					 echo" <td width=\"22%\" height=\"148\" align=\"center\"><a href=\"#\"><img src=\"admin/images/{$row['images']}\" alt=\"\" width=\"120\" height=\"144\" border=\"0\"></a><br>
																						<span class=\"style7\"><a href=\"book_detail.php?ID_Book={$row['ID_Book']}\">{$row['Na_Book']}</a></span></td>
																					  ...
																					  <tr>
																						<td align=\"left\" valign=\"top\" class=\"newtovar\">
																							...
																							<td height=\"53\"><span class=\"style7\"><a href=\"book_detail.php?ID_Book={$row['ID_Book']}\">{$row['Na_Book']}</a></span></td>
																									  ...
																									  <tr>
																										<td height=\"147\" align=\"center\"><a href=\"#\"><img src=\"admin/images/{$row['images']}\" alt=\"\" width=\"120\" height=\"144\" border=\"0\"></a></td>
																									  </tr>
																									</table>
																								</td>
																								</tr>
