	...
	?>										
									  ...
									  <td width="774"><table width="774"  border="0" cellspacing="0" cellpadding="0">
										    <tr>
																...
																<tr>
																  <td height="40" class="popular"><img src="images/spacer.gif" alt="" width="27" height="19"><span class="popular_text">Popular Book</span></td>
																</tr>
																<tr>
...
<?php     $max ="SELECT DISTINCT Number FROM bso_order ORDER BY Number DESC";
                 $result_m = mysqli_query($con,$max);
           while($rowm = mysqli_fetch_array($result_m)){
			//   echo "{$rowm['Number']} " ;
			   $bs=$rowm['Number'];
			 //  echo $bs;
		  } 
		$pop = "SELECT * FROM bso_book,bso_order WHERE bso_book.ID_book=bso_order.ID_Book ORDER BY bso_order.Number DESC LIMIT 0, 4";
$result_p = mysqli_query($con,$pop);
while($rowp = mysqli_fetch_array($result_p)){                                                            
																					 echo" <td width=\"22%\" height=\"148\" align=\"center\"><a href=\"#\"><img src=\"mos_admin/images/{$rowp['images']}\" alt=\"\" width=\"120\" height=\"144\" border=\"0\"></a><br>
																						<span class=\"style7\"><a href=\"book_detail.php?ID_Book={$rowp['ID_Book']}\">{$rowp['Na_Book']}</a></span></td>
...
$sel = "SELECT * FROM bso_book, bso_book_category  WHERE bso_book.ID_Ca=bso_book_category.ID_Ca ORDER BY bso_book.time DESC LIMIT 0, 9";
																							...
																							<table width=\"207\"  border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
																							  <tr>
																								<td height=\"200\" valign=\"top\">
																									<table width=\"100%\"  border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
																							 <tr>
																							<td height=\"53\"><span class=\"style7\"><a href=\"book_detail.php?ID_Book={$row['ID_Book']}\">{$row['Na_Book']}</a></span></td>
																									  </tr>
																									  <tr>
																										<td height=\"147\" align=\"center\"><a href=\"#\"><img src=\"mos_admin/images/{$row['images']}\" alt=\"\" width=\"120\" height=\"144\" border=\"0\"></a></td>
																									  </tr>
																									</table>
																								</td>
																								</tr>
																							  <tr>
																								<td height=\"35\">
																									<table width=\"100%\"  border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
																									  <tr>
	<td width=\"38%\" height=\"24\"><span class=\"style7\"><a href=\"book_detail.php?ID_Book={$row['ID_Book']}\">More detail</a></span></td>
																										<td width=\"23%\">&nbsp;</td>
																										<td width=\"39%\" class=\"price\">{$row['Va_Book']} ฿</td>
																									  </tr>
																									</table>
																								</td>
																							  </tr>
