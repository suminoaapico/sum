...
$user = $_SESSION["valid_user"];
$bgc = 0;
$result1 = mysqli_query($con, "SELECT bso_basket.ID_Basket ,bso_basket.ID_Book,bso_basket.ID_Member,bso_basket.Number ,bso_book.Na_Book, bso_basket.ID_Basket
FROM bso_basket,bso_member,bso_book
WHERE bso_member.Us_Member = '{$user}' AND bso_member.ID_Member = bso_basket.ID_Member AND bso_basket.ID_Book = bso_book.ID_Book ");
...
<th>รหัสหนังสือ</th><th>ชื่อหนังสือ</th><th>จำนวน</th><th>ลบ</th></tr>\n";
...
$bgc = ($bgc=="beige")?"white":"beige";
  ...
  echo "<td width =\"10%\" align=\"center\"> <a href =\"delete.php?ID_Basket={$row['ID_Basket']}\"><img src=\"images/bin.gif\"/></a> </td>";
echo "</tr>";
...
echo "</table>\n";
echo"<br/><br/><br/>";
echo "<center><a href=\"book_list_all.php\"><img src=\"images/add_ca.png\"></a> ";
echo "<a href=\"order_process.php?status=F\"><img src=\"images/add_order.png\"></a><center>";  
