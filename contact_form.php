	...
	?>										
									  ...
									  <td width="774"><table width="774"  border="0" cellspacing="0" cellpadding="0">
										    <tr>
                                                                ...
                                                                <h6 align="center"><img src="images/contact.png"></h6><br><br>
                                                                <h2>วิธีการใช้งาน</h2> 	
                                                                <h2>คำถามที่พบบ่อย</h2> 	
                                                                <h2>ติดต่อเรา</h2> 	
                                                                <img src="images/tel.png"><img src="images/email.png">
																
																<table width="774"  border="0" cellspacing="0" cellpadding="0">
																    <tr>
																      <td height="40" class="popular"><img src="images/spacer.gif" alt="" width="27" height="19"><span class="popular_text">Contact</span></td>
															        </tr>
																    <tr>
...
<?php
echo" ชือเรื่อง:<input  name=\"title\" type=\"text\" ><br/>";

echo" รายละเอียด: <textarea name=\"detail\" rows=\"5\" cols=\"40\" ></textarea><br/>";

echo" ชื่อ: <input size=\"20\" name=\"name\" type=\"text \" ><br/>";

echo" อีเมล์: <input size=\"50\" name =\"email\" type=\"\" ><br/>";
