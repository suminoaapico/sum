...
##๒๒๒๒๒๒๒๒๒๒๒๒๒๒	 เริ่มเลือกสถานะ
echo "<br><br><b>เลือกดูตามสถานะ</b> &nbsp; &nbsp;&nbsp; ";
echo "<a href=\"order_list_all.php\">ทั้งหมด</a> &nbsp; &nbsp; ";
echo " <a href=\"order_list.php?s=1\">ยังไม่ได้ชำระเงิน</a>&nbsp; &nbsp; ";
echo " <a href=\"order_list.php?s=2\">ชำระเงินยังไม่ครบ</a>&nbsp; &nbsp; ";
echo " <a href=\"order_list.php?s=3\">ชำระเงินแล้ว</a>&nbsp; &nbsp; ";
...
$result = mysqli_query($con, "SELECT *
     ...
     WHERE bso_member.ID_Member = bso_order.ID_Member AND bso_book.ID_Book = bso_order.ID_Book  AND bso_member.Us_Member =  '{$user}'   AND Status='{$status}' GROUP BY bso_order.ID_Order " );
